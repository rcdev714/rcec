  ...
  const sectionsData: Section[] = useMemo(() => [
    ...
    { 
      ...
      subsections: [
        ...
        { id: "g-start-nav", title: "1. Navega al Asistente IA" },
      ...
      content: (
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-lg !mt-0 text-gray-500">
            Descubre el poder de nuestro Asistente IA, el corazón de Camella que transforma cómo encuentras empresas. Comienza tu viaje en menos de 5 minutos.
          </p>
          
          <h2 id="g-start-guide" className="!mt-12 !mb-4 text-xl font-semibold tracking-tight">Tu Guía Paso a Paso</h2>

          <h3 id="g-start-nav" className="!mt-8 !mb-3 text-lg font-semibold tracking-tight">1. Navega al Asistente IA</h3>
          <p className="!mt-4">
            Ve al menú lateral y haz clic en &quot;Asistente&quot; para abrir el chat de IA. El plan gratuito te ofrece límites generosos para empezar:
          </p>
            <ul className="!mt-6 !space-y-3">
            ...
            <p className="!mt-4">
              Prueba el asistente preguntando por empresas en tu sector o ubicación. Aquí tienes algunos ejemplos:
            </p>
            <ul className="!mt-6 !space-y-3">
    ...
    },
    {
      ...
      content: (
        <div className="prose prose-lg max-w-none">
            <h1 className="text-3xl font-semibold tracking-tight text-gray-900 !mb-3">Asistente de IA</h1>
          <p className="text-lg !mt-0 text-gray-500">
    ...
    },
    {
      ...
      content: (
        <div className="prose prose-lg max-w-none">
          ...
          <p className="!mt-4">
            Gestiona todos los aspectos de tu suscripción en un solo lugar. Aquí puedes ver el estado actual de tu plan (activo, cancelado, etc.), la fecha de renovación y acceder a opciones para cambiar de plan o actualizar tus métodos de pago a través del portal de facturación.
          </p>
        </div>
      )
    },
